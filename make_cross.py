...
「落札が済んでいるものだけ」も大事。まだ売れていない物件を固定化すると、
...
# **理由は「住所が粗いから」ではない。人が住んでいることがあるから**
# （正本 3.1）。入札中の物件は、住んでいる人がいる状態で出ている。
# 工業地域の工場でも、競売の物件なら渡さない。
# 住所の粗さで外れるのは結果であって、理由ではない
...
def build(rows):
    ...
    return {
        ...
        "何これ": "法人が使っていた工場・倉庫・店舗などの跡地。落札が済んだものだけ",
