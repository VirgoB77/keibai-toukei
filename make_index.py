...
理由は**その家に人が住んでいることがあるから**（正本 3.1）。
入札中の物件は、住んでいる人がいる状態で出ている。落札のあとも
「あの住所は競売だった」と検索に出続けるのは重すぎる。
**これは儲かっても変わらない理由なので、これで足りる。**

住所を市区町村までしか持たないのは、その手当ての形であって、
出さない理由ではない。順番を逆にすると、住所さえ粗ければ出してよい、
と読めてしまう。あわせて (a)(b) を判定する材料
（所有者名・詳しい用途・地番）もそもそも手元に無い。
